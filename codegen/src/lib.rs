...
/// Standard "@generated" preamble pointing at chi.rs as the source of
/// truth. `comment` is the line-comment prefix for the target language
/// (`//` for TS / Go, `#` for Python). Path is read from
/// [`paths::CHI_RS_REL`] so a rename doesn't leave the header lying.
fn chi_at_generated_header(comment: &str) -> String {
    format!(
        "{c} @generated by `cargo run -p codegen` from {chi} — DO NOT EDIT.\n\
         {c}\n\
         {c} Rust is the canonical home of the wire registry. Hand-edit chi.rs;\n\
         {c} the file is regenerated on every cargo build of thrum-core (build.rs).\n\
...
fn render_helpers() -> String {
    ...
    let header = format!(
        "// @generated by `cargo run -p codegen` from thrum-core — DO NOT EDIT.\n\
         //\n\
         // Runtime helpers that mirror {}. Generated\n\
...
fn render_py_helpers() -> String {
    ...
    const BODY: &str = r#"from __future__ import annotations
