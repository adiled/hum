//! `grpc-nestling` — transport-only bridge from gRPC bidi stream to thrum.
//!
...
async fn bridge(
    ...
    let hello = serde_json::json!({
        ...
        "source": "https://github.com/adiled/hum/tree/main/nestlings/grpc"
    });
...
async fn main() -> Result<()> {
    ...
    info!(addr = %addr, "grpc-nestling.listen");
    Server::builder()
